...
<aside class="blog-sidebar">
   ...
   <div class="search-section">
      <h2>Search</h2>
      <?php
      // Obtenir l'URL de la page blog pour le formulaire de recherche
      $blog_page_id = get_page_by_path('blog');
      if ($blog_page_id) {
         $search_action = get_permalink($blog_page_id->ID);
      } else {
         $search_action = home_url('/blog/');
      }
      ?>
      <form role="search" method="get" action="<?php echo $search_action; ?>">
   ...
   <div class="archives-section">
      ...
      <ul class="archives-list">
         <?php
         // Récupérer les archives avec des liens personnalisés vers la page blog
         ...
         if ($months) {
            foreach ($months as $month) {
               ...
               // Générer l'URL vers la page blog avec le paramètre de date
               $blog_page_id = get_page_by_path('blog');
               if ($blog_page_id) {
               ...
               $archive_url = add_query_arg('m', $archive_date, $blog_url);
               
               echo '<li><a href="' . $archive_url . '">' . $month_name . ' ' . $month->year . ' (' . $month->posts . ')</a></li>';
            }
         }
         ?>
      </ul>
   ...
   <div class="categories-section">
      ...
      <ul class="categories-list">
         ...
         foreach ($categories as $category) : 
            $category_url = add_query_arg('cat', $category->term_id, $blog_url);
         ?>
            <li>
   ...
   <div class="tags-section">
      ...
      <ul class="tags-list">
         ...
         foreach ($tags as $tag) : 
            $tag_url = add_query_arg('tag', $tag->slug, $blog_url);
         ?>
            <li>
