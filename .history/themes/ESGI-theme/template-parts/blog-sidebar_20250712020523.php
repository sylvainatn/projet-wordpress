      ...
      <ul class="archives-list">
         ...
         if ($months) {
            foreach ($months as $month) {
               ...
               $current_params = $_GET;
               $current_params['m'] = $archive_date;
               $archive_url = add_query_arg($current_params, $blog_url);

               $is_active = (isset($_GET['m']) && $_GET['m'] == $archive_date) ? ' class="active"' : '';
   ...
   <div class="categories-section">
      ...
      <ul class="categories-list">
         ...
         foreach ($categories as $category) :
            ...
            $current_params = $_GET;
            $current_params['cat'] = $category->term_id;
            $category_url = add_query_arg($current_params, $blog_url);

            $is_active = (isset($_GET['cat']) && $_GET['cat'] == $category->term_id) ? ' class="active"' : '';
         ?>
   ...
   <div class="tags-section">
      ...
      <ul class="tags-list">
         ...
         foreach ($tags as $tag) :
            ...
            $is_active = (isset($_GET['tag']) && $_GET['tag'] == $tag->slug) ? ' class="active"' : '';
         ?>
            <li<?php echo $is_active; ?>>
